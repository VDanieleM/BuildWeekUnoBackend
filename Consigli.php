 ...
 <?php
    ...
    if ($herosection_post_id) {
        ...
        if (count($herosection_categories) >= 2) {
            ...
            echo '<h1 class="nellepuntateprecedenti">Consigli per godersi la vacanza a ' . $second_herosection_category . '</h1>';
        }
    } else {
        echo '<h1 class="nellepuntateprecedenti">Luoghi da esplorare a </h1>';
    }
    ?>
